...
switch enemy.name
{
	case "The Magician":
		if waveID=0
		{
			...
			CreateProjectile(2,0,25,enemy,row2,1.25,yStart)
			CreateProjectile(3,1,5,enemy,row3,1.25,yStart)
			CreateProjectile(4,1,25,enemy,row2,1.5,yStart)
			CreateProjectile(5,2,5,enemy,row1,1.5,yStart)
			CreateProjectile(7,2,5,enemy,row3,1.5,yStart)
			
			if !instance_exists(obj_defendProjectileParent){instance_destroy(self)}
		}
		if waveID=1
		{
			CreateProjectile(1,0,0,enemy,row1,1,yStart,,1)
			CreateProjectile(2,1,0,enemy,row2,1.25,yStart)
			CreateProjectile(3,1,45,enemy,row3,1.25,yStart)
			CreateProjectile(4,2,30,enemy,row2,1.25,yStart)
			CreateProjectile(5,3,18,enemy,row3,1.25,yStart)
			CreateProjectile(6,3,22,enemy,row2,1.25,yStart)
		...
		if waveID=2
		{
			...
			CreateProjectile(2,0,0,enemy,row3,1,yStart,,1)
	...
	case  "Scaly Feline":
		...
		{
			CreateProjectile(1,0,0,enemy,row1,1,yStart,1)
			CreateProjectile(2,1,0,enemy,row3,1,yStart,1)
			CreateProjectile(3,2,0,enemy,row1,1,yStart)
			CreateProjectile(4,2,0,enemy,row2,1,yStart)
			CreateProjectile(5,2,50,enemy,row3,1,yStart,1)
		...
		{
			CreateProjectile(1,0,0,enemy,row1,1,yStart)
			CreateProjectile(2,0,0,enemy,row3,1,yStart)
			CreateProjectile(3,0,45,enemy,row2,1,yStart)
			CreateProjectile(4,1,45,enemy,row1,1,yStart,1)
			CreateProjectile(5,2,45,enemy,row3,1,yStart,1)
	...
	case "Nightcrawler":
		...
		if waveID=0
		{
			CreateProjectile(1,0,0,enemy,row1,1.15,yStart,,1)
			CreateProjectile(2,0,45,enemy,row1,1.15,yStart,,1)	
			CreateProjectile(3,0,45,enemy,row3,1.15,yStart)	
			CreateProjectile(4,1,30,enemy,row2,1.15,yStart)	
			CreateProjectile(5,2,0,enemy,row3,1.15,yStart)	
		...
		{
			CreateProjectile(1,0,0,enemy,row1,1.15,yStart,,1)
			CreateProjectile(2,0,0,enemy,row3,1.15,yStart,,1)
			CreateProjectile(3,1,0,enemy,row2,1.15,yStart)
			CreateProjectile(4,1,0,enemy,row3,1.15,yStart)
			CreateProjectile(5,1,45,enemy,row1,1.15,yStart)
			CreateProjectile(6,1,45,enemy,row2,1.15,yStart)
			CreateProjectile(7,2,05,enemy,row2,1.15,yStart)
			CreateProjectile(9,2,40,enemy,row2,1.15,yStart,,1)
		...
		if waveID=2
		{
			...
			CreateProjectile(2,0,0,enemy,row3,1.15,yStart,,1)
			CreateProjectile(3,1,0,enemy,row2,1.15,yStart)
			CreateProjectile(4,1,0,enemy,row1,1.15,yStart)
			CreateProjectile(5,1,45,enemy,row3,1.15,yStart)
			CreateProjectile(6,1,45,enemy,row2,1.15,yStart)
			CreateProjectile(7,2,05,enemy,row2,1.15,yStart)
			CreateProjectile(9,2,40,enemy,row2,1.15,yStart,,1)
