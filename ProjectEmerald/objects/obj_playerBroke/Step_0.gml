if(global.broke = 1)
{
	...
	if ((global.quest.blueRing.available = false) && (global.quest.blackRing.available = false))
	{
	...
	if global.BcurrentHP <= 0
	{
		...
		{
			instance_create_depth(obj_playerBroke.x,obj_playerBroke.y,-16000,obj_playerEssenceRotate3_1)
			instance_create_depth(obj_playerBroke.x,obj_playerBroke.y,-16000,obj_playerEssenceRotate3_2)
			instance_create_depth(obj_playerBroke.x,obj_playerBroke.y,-16000,obj_playerEssenceRotate3_3)
		}
