if enemy
{
	...
	{
		subimg+=.2
		draw_sprite_ext(spr_magicianBattleIdle,subimg,x,y,1.1,.95,0,c_white,1)
	}
	...
	if name="Jenna"
	{
		...
		draw_sprite_ext(spr_jennaHead,subimg,x,y+yy/1.5,1.1,.95,0,c_white,1)
	
		if talking{draw_sprite_ext(spr_jennaHead2,subimg/1.5,x,y+yy/1.5,1.1,.95,0,c_white,1)}
