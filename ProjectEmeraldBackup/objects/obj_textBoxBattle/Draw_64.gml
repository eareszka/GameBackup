...
/******************************************************
	this textbox is only used during battles
*****************************************************/
if timer < 0 
{
	accept_key = keyboard_check_pressed(vk_space);
	...
	*************************/
	...
	draw_sprite_ext(spr_textBox, txtb_img, _txtb_x, _txtb_y, textbox_width/txtb_spr_w, textbox_height/txtb_spr_h, 0, c_white, 1)
	...
	*************************/
	...
	draw_sprite_ext(sDownArrow,-1,textbox_x + (textbox_width/2), textbox_y + (textbox_height) + 3,1.5,1.5,-1,c_white,1)
}
