		...
		case "babyWorm":
			switch _scene
			{
				...
				case 1:
					...
					if !instance_exists(oShakeCamera){instance_create_depth(0,0,-9999,oShakeCamera)}
					...
					//cutscene_setSprite(oBabyWormOverworld,spr_babyWormOverworld,0,7)
				break;
				case 2:
					obj_playerEmory.sprite_index = emory_b_walking
					oBabyWormOverworld.image_index = 9
					cutscene_move_obj(obj_playerEmory,266,300,1.5,true)	
				break;
				case 3:
					...
					{
						create_textbox("EmoryTalk1")
					}
				break;
				case 4:
					obj_playerEmory.sprite_index = emory_b_walking
					cutscene_setSprite(oBabyWormOverworld,spr_babyWormOverworld,10,19)
					cutscene_move_obj(obj_playerEmory,266,310,.2,false)
					cutscene_move_obj(oBabyWormOverworld,270,240,.5,true)
				break;
				case 5:		
					obj_playerEmory.sprite_index = emory_b_idle
					oBabyWormOverworld.image_index = 9
				...
				case 6:
					obj_playerEmory.sprite_index = emory_b_walking
					cutscene_setSprite(oBabyWormOverworld,spr_babyWormOverworld,10,19)
					cutscene_move_obj(obj_playerEmory,266,315,.2,false)
					cutscene_move_obj(oBabyWormOverworld,270,270,.5,true)	
				break;
				case 7:
					obj_playerEmory.sprite_index = emory_b_idle
					oBabyWormOverworld.image_index = 9
				...
				case 8:
					obj_playerEmory.sprite_index = emory_b_walking
					cutscene_setSprite(oBabyWormOverworld,spr_babyWormOverworld,10,19)
					cutscene_move_obj(obj_playerEmory,266,320,.2,false)
					cutscene_move_obj(oBabyWormOverworld,270,300,.6,true)	
				break;
				case 9:
					obj_playerEmory.sprite_index = emory_f_walking
					cutscene_move_obj(obj_playerEmory,266,350,.6,false)
					cutscene_move_obj(oBabyWormOverworld,270,346,1,true)	
				break
				case 10:
				...
				case 11:
					global.flag[1] = 1
					obj_playerEmory.sprite_index=emory_b_idle
					obj_playerEmory.x=266
					obj_playerEmory.y=380
